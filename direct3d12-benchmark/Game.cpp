...
void Game::CreateDevice()
{
    ...
    m_model = Model::CreateFromSDKMESH(m_d3dDevice.Get(), L"C:\\dev\\direct3d12-benchmark\\direct3d12-benchmark\\chair.sdkmesh");
...
void Game::CreateResources()
{
    ...
    else
    {
        ...
        m_view = Matrix::CreateLookAt(Vector3(1.0f, 1.0f, 1.0f),Vector3::Zero, Vector3::UnitY);
