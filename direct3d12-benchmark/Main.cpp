...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"Direct3D12_BenchmarkWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"Direct3D12_BenchmarkWindowClass", L"direct3d12-benchmark", WS_OVERLAPPEDWINDOW,
